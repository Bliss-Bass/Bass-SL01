...
{    
    ...
    if [ "$USE_ALWAYS_ON_SETTINGS" = "true" ]; then
        ...
        echo ""
        sed -i 's/def_screen_off_timeout">900000/def_screen_off_timeout">600000000/g' frameworks/base/packages/SettingsProvider/res/values/defaults.xml
        sed -i 's/def_sleep_timeout">86400000/def_sleep_timeout">-1/g' frameworks/base/packages/SettingsProvider/res/values/defaults.xml
        ...
        sed -i 's/def_screen_off_timeout">600000000/def_screen_off_timeout">900000/g' frameworks/base/packages/SettingsProvider/res/values/defaults.xml
        sed -i 's/def_sleep_timeout">-1/def_sleep_timeout">86400000/g' frameworks/base/packages/SettingsProvider/res/values/defaults.xml
    ...
    if [ "$USE_SHOW_KEYBOARD" = "true" ]; then
        ...
        echo ""
        sed -i 's/def_show_ime_with_hard_keyboard">false/def_show_ime_with_hard_keyboard">true/g' frameworks/base/packages/SettingsProvider/res/values/defaults.xml
        ...
        echo ""
        sed -i 's/def_show_ime_with_hard_keyboard">true/def_show_ime_with_hard_keyboard">false/g' frameworks/base/packages/SettingsProvider/res/values/defaults.xml
    ...
    if [ "$USE_PER_DISPLAY_FOCUS" = "true" ]; then
        ...
        echo ""
        sed -i 's/config_perDisplayFocusEnabled">false/config_perDisplayFocusEnabled">true/g' frameworks/base/core/res/res/values/config.xml
        ...
        echo ""
        sed -i 's/config_perDisplayFocusEnabled">true/config_perDisplayFocusEnabled">false/g' frameworks/base/core/res/res/values/config.xml
...
function build_config()
{
    ...
    echo "    ro.bliss.build=$BASS_BUILD_FILENAME \\" >> $PWD/../bass/tmp/bass_build_config.mk
    ...
    echo '    $(LOCAL_PATH)/build_config:system/etc/build_config' >> $PWD/../bass/tmp/bass_build_config.mk
    echo " " >> $PWD/../bass/tmp/bass_build_config.mk
...
{
	args=("$@")
    bash vendor/$vendor_name/tools/build-rpi4.sh "${args[@]}"

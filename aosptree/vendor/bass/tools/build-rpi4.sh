...
function displayHelp() {
    ...
    echo "--useampl          Include AstraMail email for platform"
...
if [ $# -eq 0 ]; then
    ...
    echo "bash build-rpi4.sh $*" > .bbconfig/last_command
fi
...
export USE_ASTRA_MAIL=${USE_ASTRA_MAIL:-false};
...
echo "IncludeAstraMailemailforplatform: ${USE_ASTRA_MAIL}";
...
if [ "$MAKE_ONLY_IMAGES" = "true" ]; then
    ...
    make images sdcardzip -k || if [ ! "$MAKE_SD_ONCE" = "true" ]; then make images sdcardzip -j1; fi
fi

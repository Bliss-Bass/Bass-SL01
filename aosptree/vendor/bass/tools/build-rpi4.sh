...
export FORCE_WIN_AS_HOME=false
export MAKE_ONLY_IMAGES=false
...
function displayHelp() {
    ...
    echo "--winashome          Force win key to act as home key"
    echo "--makeimages          Build only the image files (for debugging)"
...
while [[ $# -gt 0 ]]; do
    case "$1" in
        ...
        --vapor)
               ...
               ;;
        --winashome)
               FORCE_WIN_AS_HOME=true
               shift
               ;;
        --makeimages)
               MAKE_ONLY_IMAGES=true
               shift
               ;;
        --darkmode)
               SET_DARKMODE=true
...
export FORCE_WIN_AS_HOME=${FORCE_WIN_AS_HOME:-false};
export MAKE_ONLY_IMAGES=${MAKE_ONLY_IMAGES:-false};
...
echo "Forcewinkeytoactashomekey: ${FORCE_WIN_AS_HOME}";
echo "Buildonlytheimagefilesfordebugging: ${MAKE_ONLY_IMAGES}";
